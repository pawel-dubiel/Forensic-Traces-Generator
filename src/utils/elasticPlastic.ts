export type ElasticPlasticMaterialKey = 'aluminum' | 'brass' | 'steel' | 'wood' | 'gold';

export interface ElasticPlasticMaterialProps {
  youngModulusGPa: number;
  yieldStrengthMPa: number;
  hardeningModulusMPa: number;
}

export interface ElasticPlasticResult {
...
const assertPositiveFinite = (value: number, label: string, material?: string) => {
...
export const validateElasticPlasticMaterial = (
  material: ElasticPlasticMaterialProps,
  name?: string
) => {
...
export const ELASTIC_PLASTIC_MATERIALS: Record<ElasticPlasticMaterialKey, ElasticPlasticMaterialProps> = {
...
export const getElasticPlasticMaterial = (material: ElasticPlasticMaterialKey) => {
...
export class ElasticPlasticModel {
  private readonly youngModulusMPa: number;
  private readonly yieldStrengthMPa: number;
  private readonly hardeningModulusMPa: number;

  constructor(material: ElasticPlasticMaterialProps) {
  ...
  computePermanentDepth(
    penetration: number,
    characteristicLength: number,
    plasticStrain: number
  ): ElasticPlasticResult {

...
const seed = 1337;
const createKernel = (engine, angleDeg = 45) => engine.createToolKernel('screwdriver', 6, 0.1, angleDeg, 0, {
...
const simulate = (force, toolHardness, material = 'aluminum', chatter = 0, angleDeg = 45) => {
